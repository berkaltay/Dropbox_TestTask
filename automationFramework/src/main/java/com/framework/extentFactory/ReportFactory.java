package com.framework.extentFactory;
...
public class ReportFactory {
    ...
    private static ExtentHtmlReporter setPropertiesOfReport() {
        ...
        extentHtmlReporter.config().setReportName("Automation Base Project");
    ...
    public static synchronized ExtentTest createTest(String parentName, String category) {
        String newParentName = parentName.split("\\.")[parentName.split("\\.").length - 1];
        ExtentTest parent = extentReports.createTest(newParentName).assignCategory(category);
